...
public class Aligner
{
  ...
  public static final VerticalAligner TOP = new VerticalAligner()
  {
  ...
  public static final VerticalAligner VERTICAL_CENTER = new VerticalAligner()
  {
    public int startingY(Box area, int consumedHeight)
    {
  ...
  public static final VerticalAligner BOTTOM = new VerticalAligner()
  {
    public int startingY(Box area, int consumedHeight)
    {
  ...
  public static final HorizontalAligner LEFT = new HorizontalAligner(){
  ...
  public static final HorizontalAligner HORIZONTAL_CENTER = new HorizontalAligner(){
  ...
  public static final HorizontalAligner RIGHT = new HorizontalAligner(){
  ...
  private final HorizontalAligner horizontalAlignment;
  private final VerticalAligner verticalAlignment;
