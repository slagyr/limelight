...
public class CheckBoxPainterTest extends TestCase
{
  private limelight.ui.model.Panel panel;
  private CheckBoxPainter painter;
  ...
  public void setUp() throws Exception
  {
    ...
    painter = new CheckBoxPainter(panel);
  ...
  public void testThatACheckboxIsAddedToThePanel() throws Exception
  {
    ...
    assertEquals(JCheckBox.class, panel.getComponents()[0].getClass());
  }
  ...
  {
    JCheckBox field = (JCheckBox)panel.getComponents()[0];
