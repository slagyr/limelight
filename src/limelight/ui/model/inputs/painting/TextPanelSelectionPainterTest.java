...
public class TextPanelSelectionPainterTest extends AbstractTextPanelPainterTest
{
  ...
  public void willFillABoxAroundSelectedText()
  {
    ...
    assertEquals(new Box(40, 0, 20, 13), graphics.filledShapes.get(0).shape);
  }
  ...
  public void willFillMultipleBoxesForMultiLinedSelectedText()
  {
    ...
    assertEquals(new Box(20, 0, 130, 13), graphics.filledShapes.get(0).shape);
    assertEquals(new Box(0, 13, 50, 13), graphics.filledShapes.get(1).shape);
  }
}
