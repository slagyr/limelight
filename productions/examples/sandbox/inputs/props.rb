...
#    # end row
    ...
    # end row
    cell { combo_box_input :players => "combo_box", :choices => "%w{Red Orange Yellow Green Blue Indigo Violet}", :id => "combo_box_input" }
  	cell { input_log :id => "combo_box_log" }
  	cell(:border_width => "1") { input_results :id => "combo_box_results" }
    # end row
    cell { button_input :players => "button", :text => "A Button", :id => "button_input" }
