...
#include "limelight_os_darwin_DarwinNativeInterface.h"
#import <Carbon/Carbon.h>	// Needed for kiosk api functions

SystemUIMode originalMode;
SystemUIOptions originalOptions;

JNIEXPORT void JNICALL Java_limelight_os_darwin_DarwinNativeInterface_turnOnKioskMode(JNIEnv *env, jobject obj)
{
...
JNIEXPORT void JNICALL Java_limelight_os_darwin_DarwinNativeInterface_turnOffKioskMode(JNIEnv *env, jobject obj)
{
